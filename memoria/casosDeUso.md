...
**Resumen:**  
Una vez que el Estudiante/Profesor ha cursado total o parcialmente un curso, el sistema le ofrece la opción de dejar una reseña. Esta puede incluir una valoración numérica y un comentario textual.
...
**Precondiciones:**  
- El Estudiante/Profesor debe estar identificado en el sistema.  
- El Estudiante/Profesor debe haber accedido a al menos un bloque de contenido del curso.
...
**Postcondiciones:**  
- La reseña del Estudiante/Profesor queda guardada y visible para otros usuarios.
